...
config :shop2, Shop2Web.Endpoint,
  ...
  render_errors: [
    formats: [html: Shop2Web.ErrorHTML, json: Shop2Web.ErrorJSON],
    layout: false
  ],
  pubsub_server: Shop2.PubSub,
  live_view: [signing_salt: "t4mxA8JV"]
...
config :shop2, Shop2.Mailer, adapter: Swoosh.Adapters.Local
